...
Log4js.configure({
  appenders: {
    ...
    json_data_native_douyu: {
      ...
      filename: `./data-native-douyu.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    ...
    json_data_native_longzhu: {
      ...
      filename: `./data-native-longzhu.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_quanmin: {
      ...
      filename: `./data-native-quanmin.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_zhanqi: {
      ...
      filename: `./data-native-zhanqi.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_chushou: {
      ...
      filename: `./data-native-chushou.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_panda: {
      ...
      filename: `./data-native-panda.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_fanxing: {
      ...
      filename: `./data-native-fanxing.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_huoshan: {
      ...
      filename: `./data-native-huoshan.log`,
      maxLogSize: 512 * 1024 * 1024,
      backups: 4
    },
    json_data_native_yy: {
