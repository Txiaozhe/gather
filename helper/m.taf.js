...
function TafHandler(t) {
  function e() {
    var t = p.url || "ws://ws.api.huya.com";
    p.ISDEBUG && (t = "ws://ws.api.huya.com"),
      d.info("%cconnecting " + t, a("#0000E3")),
      u = new WebSocket(t),
      u.onopen = r,
      u.onclose = n,
      u.onerror = s,
  ...
  function n(t) {
    c.connected = !1,
      d.warn("%c=== WebSocket Closed ===", "font-size:120%", t),
      10 > f ? (f++,
        d.warn("%c=== WebSocket \u91cd\u8fde" + f + "... ===", "font-size:120%"),
        setTimeout(e, 1e3)) : d.warn("%c=== WebSocket\u91cd\u8fde\u6b21\u6570\u8d85\u6807 ===", "font-size:120%");
    c.dispatch('close');
  }

  function s(t) {
    d.warn("%c=== WebSocket Error ===", "font-size:120%", t);
    c.dispatch('error', t);
  }

  function o(t) {
    var e = new Taf.JceInputStream(t.data),
    ...
    switch (i.readFrom(e),
      ...
      case HUYA.EWebSocketCommandType.EWSCmd_RegisterRsp:
        ...
        r.readFrom(e),
          d.log("%c<<<<<<< %crspRegister", a("#0000E3"), a("#D9006C"), r),
          c.dispatch('rawdata', {cmd: "WSRegisterRsp", data: r});
        break;
      case HUYA.EWebSocketCommandType.EWSCmd_WupRsp:
        var n = new Taf.Wup;
        n.decode(i.vData.buffer);
        var s = TafMx.WupMapping[n.sFuncName];
        if (s) {
          s = new s;
          var o = n.newdata.get("tRsp") ? "tRsp" : "tResp";
          n.readStruct(o, s, TafMx.WupMapping[n.sFuncName]),
            d.log("%c<<<<<<< %crspWup:%c " + n.sFuncName, a("#0000E3"), a("black"), a("#0000E3"), s),
            c.dispatch('rawdata', {cmd: n.sFuncName, data: s})
        } else
          c.dispatch('rawdata', {cmd: n.sFuncName});
        break;
      case HUYA.EWebSocketCommandType.EWSCmdS2C_MsgPushReq:
        e = new Taf.JceInputStream(i.vData.buffer);
        var h = new HUYA.WSPushMessage;
        h.readFrom(e),
          e = new Taf.JceInputStream(h.sMsg.buffer);
        var p = TafMx.UriMapping[h.iUri];
        p && (p = new p,
          p.readFrom(e),
          d.log("%c<<<<<<< %crspMsgPush, %ciUri=" + h.iUri, a("#0000E3"), a("black"), a("#8600FF"), p),
          c.dispatch('rawdata', {cmd: h.iUri, data: p}));
        break;
      case HUYA.EWebSocketCommandType.EWSCmdS2C_HeartBeatAck:
        d.log("%c<<<<<<< rspHeartBeat: " + (new Date).getTime(), a("#0000E3"));
        break;
      case HUYA.EWebSocketCommandType.EWSCmdS2C_VerifyCookieRsp:
        ...
        u.readFrom(e);
        var f = 0 == u.iValidate;
        d.log("%c<<<<<<< %cVerifyCookie", a("#0000E3"), a("#D9006C"), "\u6821\u9a8c" + (f ? "\u901a\u8fc7\uff01" : "\u5931\u8d25\uff01"), u);
        break;
      default:
        d.warn("%c<<<<<<< Not matched CmdType: " + i.iCmdType, a("#red"))
    }
  }
  ...
  var d = {
    info: function () {
      return h ? console.info.apply(null, arguments) : void 0
    },
    log: function () {
      return h ? console.log.apply(null, arguments) : void 0
    },
    warn: function () {
      return h ? console.warn.apply(null, arguments) : void 0
    }
  };
  this.connected = !1;
  var u, c = this,
    f = 0;
  e(),
    this.sendWup = function (t, e, r) {
      var n = new Taf.Wup;
      n.setServant(t),
        n.setFunc(e),
        n.writeStruct("tReq", r);
      var s = new HUYA.WebSocketCommand;
      s.iCmdType = HUYA.EWebSocketCommandType.EWSCmd_WupReq,
        s.vData = n.encode();
      var o = new Taf.JceOutputStream;
      s.writeTo(o),
        i(o.getBuffer()),
        d.log("%c>>>>>>> %creqWup: %c" + e, a("#009100"), a("black"), a("#009100"), r)
    },
    this.sendRegister = function (t) {
      var e = new Taf.JceOutputStream;
      t.writeTo(e);
      var r = new HUYA.WebSocketCommand;
      r.iCmdType = HUYA.EWebSocketCommandType.EWSCmd_RegisterReq,
        r.vData = e.getBinBuffer(),
        e = new Taf.JceOutputStream,
        r.writeTo(e),
        i(e.getBuffer()),
        d.log("%c>>>>>>> %creqRegister:", a("#009100"), a("#D26900"), t)
    };
  var I = {};
  this.addListener = function (t, e) {
      return "undefined" == typeof I[t] && (I[t] = []),
        "function" == typeof e && I[t].push(e),
        this
    },
    this.dispatch = function (t, e) {
      var i = I[t];
      if (i instanceof Array) {
        for (var r = 0, n = i.length; n > r; r += 1)
          "function" == typeof i[r] && i[r](e);
        0 == i.length
      }
      return this
    },
    this.removeListener = function (t, e) {
      var i = I[t];
      if ("string" == typeof t && i instanceof Array)
